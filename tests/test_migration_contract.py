...
TEST_CENSUS = {
    ...
    "test_megatron_stock_driver": 103,
    ...
    # to.
    # +6 with the pipeline cap at 8: rule 2's two halves in the order that
    # keeps the pipeline message reachable, rule 7 at eight stages for every
