...
from benchmarks.models.piper_qwen3.components.lm_head.piper_optimized_cross_entropy import (
    piper_optimized_cross_entropy,
)
from benchmarks.models.piper_qwen3.components.lm_head.te_cross_entropy import (
    ...
    def test_vendored_sources_only_change_import_paths(self) -> None:
        ...
        sources = {
            ...
            "te_triton_cross_entropy.py": (
                ...
                (
                    (
                        "from benchmarks.models.piper_qwen3.components.lm_head."
                        "te_common_cross_entropy import (",
            ...
            "te_cross_entropy.py": (
                ...
                (
                    (
                        "from benchmarks.models.piper_qwen3.components.lm_head "
                        "import te_triton_cross_entropy as triton_cross_entropy",
