...
DISPATCHER_ALLTOALL: McoreProfile = derive(
    ...
    description=(
        ...
        "inert and the arm measures what the dispatcher class does locally -- "
        "its reordering and its sync strategy -- never communication. Which "
        "half of the round trip an arm sees is its own scenario's to state. "
        "The two classes place the "
