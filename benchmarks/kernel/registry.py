...
ROPE = KernelScenario(
    ...
    inputs_builder="benchmarks.kernel.operations.arms:rope_inputs",
    reference_builder="benchmarks.kernel.operations.arms:rope_reference",
    baseline_arm="baseline",
    arms=(
        KernelArm(
            name="copy_floor",
            description="q/k copy_ pair: the bandwidth floor for this shape",
            builder="benchmarks.kernel.operations.arms:build_rope_copy_floor",
            modes=("forward",),
            is_floor=True,
        ),
        KernelArm(
            ...
            builder="benchmarks.kernel.operations.arms:build_rope_baseline",
        ...
        KernelArm(
            ...
            builder="benchmarks.kernel.operations.arms:build_rope_helion",
            modes=("forward", "backward"),
            compiled=True,
            correctness=(
                CorrectnessCheck(
        ...
        KernelArm(
            ...
            builder="benchmarks.kernel.operations.arms:build_rope_te",
            modes=("forward", "backward"),
...
SWIGLU = KernelScenario(
    ...
    inputs_builder="benchmarks.kernel.operations.arms:swiglu_inputs",
    ...
    arms=(
        KernelArm(
            ...
            builder="benchmarks.kernel.operations.arms:build_swiglu_baseline",
            modes=MODES,
            compiled=True,
        ),
        KernelArm(
            ...
            builder="benchmarks.kernel.operations.arms:build_swiglu_piper_optimized_triton",
            modes=MODES,
            compiled=True,
            correctness=(
                CorrectnessCheck(
        ...
        KernelArm(
            ...
            builder="benchmarks.kernel.operations.arms:build_swiglu_piper_optimized_inductor",
            modes=MODES,
            compiled=True,
            correctness=(
                CorrectnessCheck(
...
QKV = KernelScenario(
    ...
    inputs_builder="benchmarks.kernel.operations.arms:qkv_inputs",
    reference_builder="benchmarks.kernel.operations.arms:qkv_reference",
    baseline_arm="baseline",
    arms=(
        KernelArm(
            name="baseline",
            description="TorchTitan QKVLinear: separate Q and KV GEMMs",
            builder="benchmarks.kernel.operations.arms:build_qkv_baseline",
            modes=MODES,
            compiled=True,
            correctness=(
                CorrectnessCheck(
        ...
        KernelArm(
            ...
            builder="benchmarks.kernel.operations.arms:build_qkv_fused_qkv",
            modes=MODES,
            compiled=True,
            correctness=(
                CorrectnessCheck(
...
LM_HEAD = KernelScenario(
    ...
    inputs_builder="benchmarks.kernel.operations.arms:lm_head_inputs",
    reference_builder=None,
    baseline_arm="baseline",
    arms=(
        KernelArm(
            ...
            builder="benchmarks.kernel.operations.arms:build_lm_head_baseline",
        ...
        KernelArm(
            ...
            builder="benchmarks.kernel.operations.arms:build_lm_head_fused_linear_ce",
            modes=("forward_backward",),
            compiled=True,
            correctness=(
                CorrectnessCheck(
        ...
        KernelArm(
            ...
            builder="benchmarks.kernel.operations.arms:build_lm_head_te_fused_ce",
            modes=("forward_backward",),
            compiled=True,
            correctness=(
                CorrectnessCheck(
        ...
        KernelArm(
            ...
            builder="benchmarks.kernel.operations.arms:build_lm_head_piper_optimized_te_ce",
            modes=("forward_backward",),
            compiled=True,
            correctness=(
                CorrectnessCheck(
...
ATTENTION = KernelScenario(
    ...
    inputs_builder="benchmarks.kernel.operations.arms:attention_inputs",
    reference_builder="benchmarks.kernel.operations.arms:attention_reference",
    baseline_arm="baseline",
    arms=(
        KernelArm(
            name="baseline",
            ...
            builder="benchmarks.kernel.operations.arms:build_attention_baseline",
        ...
        KernelArm(
            ...
            builder="benchmarks.kernel.operations.arms:build_attention_flex_flash",
            modes=("forward", "forward_backward"),
            compiled=True,
            correctness=(ATTENTION_GATE,),
        ),
        KernelArm(
            ...
            builder="benchmarks.kernel.operations.arms:build_attention_flash3",
            modes=("forward", "forward_backward"),
            compiled=True,
            correctness=(
                ATTENTION_GATE,
